 ...
 * what happened, and the infrastructure decides how it leaves the process (Kafka now, outbox in
 * Phase 3). Keeping it in the domain lets the application layer stay ignorant of Kafka.
 */
