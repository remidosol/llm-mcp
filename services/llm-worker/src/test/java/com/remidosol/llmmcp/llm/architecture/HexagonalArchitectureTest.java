package com.remidosol.llmmcp.llm.architecture;
...
@AnalyzeClasses(packages = "com.remidosol.llmmcp.llm", importOptions = ImportOption.DoNotIncludeTests.class)
class HexagonalArchitectureTest {
    ...
    static final ArchRule api_does_not_touch_infrastructure = noClasses()
            ...
            .allowEmptyShould(true); // llm-worker has no public API (actuator only) — rule kept for symmetry
